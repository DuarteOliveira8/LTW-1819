...
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('What do you think about Logics new album?','Its my favourite album of the year tbh.','2018-09-20',2,14,2);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Im about to tell my boss that I stole almost $5000','No one even has a clue the money is missing but I just cant hide it anymore.... I just posted this to vent and maybe help with my anxiety','2018-11-30',3,5,1);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Our idea of God tells us more about ourselves','-Charles King.','2018-12-01',4,12,5);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('What are schools called that i can attend in holidays.','I live in Melbourne and am seriously falling behind in work. I was wondering what are the schools called that I can attend in the holidays so I can catch up on work.','2018-11-20',5,2,1);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('You Are Living Proof That God Has A Sense Of Humor','True Story.','2018-11-05',6,24,3);
...
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('FC Porto is the best club in Europe right now','Maregod.','2018-09-19',1,240,6);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('I fear one day I will meet God, he Will sneeze and I wont know what to say.','-Ronnie Shakes','2018-12-01',9,55,5);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Yes.','no.','2018-08-21',10,0,9);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('I think you are cool','NOT.','2018-06-07',11,2,3);
...
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Grandpa: What has 4 legs, but isnt alive?','Boy: A chair, haha, nice try gran- Grandpa - its your dog. Hes dead Jimmy.','2018-05-11',1,20,9);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('The recipe said, “Set the oven to 180 degrees.”','Now I cant open it, as the door faces the wall.','2018-05-05',1,200,9);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('What is better than a terabyte?','An Antero-byte.','2018-05-01',1,15,3);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Tik tok','It hurts my kidney.','2018-04-26',13,5000,9);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('I love youtube rewind','Dont judge me.','2018-05-26',14,-100,9);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Fnatic wins World Cup','Congratulations EU!','2018-04-26',15,2,7);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('TIFU by watering my christmas tree','By watering it too much, it fell over the vase and damaged my wooden floor. RIP.','2018-05-26',16,210,10);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('cursed_riding','Image.','2018-04-26',17,2420,8);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Can anyone help me with Math?','I cant seem to understand factorials.','2018-03-26',12,44,4);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Can anyone help me with Physics?','I cant seem to understand electricity.','2018-05-21',13,42,4);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Can anyone help me with Science?','I cant seem to understand cells.','2018-11-16',11,444,4);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Can anyone help me with English?','I cant seem to understand grammar.','2018-01-24',9,4,4);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Can anyone help me with French?','I cant seem to understand verbs.','2018-12-01',7,414,4);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Can anyone help me with Human Anatomy?','I cant seem to understand the arm.','2018-02-22',5,24,4);
INSERT INTO STORY (title, description, storyDate, idAuthor, upvoteRatio, channel) VALUES ('Can anyone help me with Dog Anatomy?','I cant seem to understand it properly.','2018-04-24',6,14,4);
